function Experiment = set_up_design(Experiment, nRuns, nTrials)


Timing = Experiment.Timing;

Experiment.Design.nRuns = nRuns;
...
% create table
Design.trialInfo = table(trial', stimulusOrientations', stimPos, distractorOrientations', distPos, probeOrientations', itis, 'VariableNames', {'trial', 'stimulus', 'stimPos', 'distractor', 'distPos', 'probe', 'itis'});

Design.timingInfo = timingInfo;

% Assign Design to Experiment, extra treatment for training trials
Experiment.Design.Run(iRun) = Design;
